...
export const metadata: Metadata = {
  title: "Guides",
  description: "How print areas, artwork, fabric, embroidery and sizing actually work.",
};
        ...
        <div className="container-pe py-8 lg:py-10">
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-[13px] text-muted">
              ...
              <li className="text-ink">Guides</li>
            </ol>
          </nav>

          <h1 className="mt-6 text-h1m lg:text-h1">Guides</h1>
          <p className="mt-3 max-w-xl text-[15px] leading-relaxed text-muted">How print areas, artwork, fabric, embroidery and sizing actually work.</p>
