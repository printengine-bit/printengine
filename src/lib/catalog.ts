...
export const megaMenu: Record<string, { heading: string; links: MegaLink[] }[]> = {
  Men: [
    { heading: "T-shirts", links: [
      { label: "Oversized Black", href: "/product/oversized-black" },
      { label: "Oversized Off-white", href: "/product/oversized-off-white" },
      { label: "Oversized Grey", href: "/product/oversized-grey" },
      { label: "Oversized Olive", href: "/product/oversized-olive" },
      { label: "Oversized Brown", href: "/product/oversized-brown" },
      { label: "Oversized Navy", href: "/product/oversized-navy" },
      { label: "Vintage washed tee", href: "/product/vintage-washed-tee" },
      { label: "Minimal logo tee", href: "/product/minimal-logo-tee" },
      { label: "All t-shirts", href: "/shop/t-shirts?gender=Men" },
    ] },
    { heading: "Streetwear", links: [
      { label: "Oversized hoodie", href: "/product/streetwear-oversized-hoodie" },
      { label: "Boxy sweatshirt", href: "/product/boxy-sweatshirt" },
      { label: "Cargo pants", href: "/product/cargo-pants" },
      { label: "Varsity jacket", href: "/product/varsity-jacket" },
      { label: "All streetwear", href: "/shop/streetwear?gender=Men" },
    ] },
    { heading: "Sports", links: [
      { label: "Football jersey", href: "/product/pro-football-jersey" },
      { label: "Basketball jersey", href: "/product/basketball-jersey" },
      { label: "Oversized sports tee", href: "/product/oversized-sports-tee" },
      { label: "Dry-fit gym tee", href: "/product/dry-fit-gym-tee" },
      { label: "All sports", href: "/shop/sports?gender=Men" },
    ] },
    { heading: "Medical & accessories", links: [
      { label: "Piped medical tunic", href: "/product/piped-medical-tunic" },
      { label: "Men's short lab coat", href: "/product/mens-short-lab-coat" },
      { label: "Maroon scrub set", href: "/product/maroon-scrub-set" },
      { label: "Premium cap", href: "/product/premium-cap" },
      { label: "Tote bag", href: "/product/tote-bag" },
      { label: "Sling / crossbody bag", href: "/product/crossbody-bag" },
      { label: "Crew socks", href: "/product/crew-socks" },
      { label: "All accessories", href: "/shop/accessories?gender=Men" },
      { label: "All medical uniforms", href: "/shop/doctor-aprons?gender=Men" },
    ] },
  ],
  Women: [
    { heading: "T-shirts", links: [
    ...
    { heading: "Streetwear", links: [
      ...
      { label: "Cargo pants", href: "/product/cargo-pants" },
      { label: "Varsity jacket", href: "/product/varsity-jacket" },
      { label: "All streetwear", href: "/shop/streetwear?gender=Women" },
    ] },
    { heading: "Sports", links: [
      { label: "Football jersey", href: "/product/pro-football-jersey" },
      { label: "Basketball jersey", href: "/product/basketball-jersey" },
      { label: "Oversized sports tee", href: "/product/oversized-sports-tee" },
      { label: "Dry-fit gym tee", href: "/product/dry-fit-gym-tee" },
      { label: "All sports", href: "/shop/sports?gender=Women" },
    ] },
    { heading: "Medical & accessories", links: [
      { label: "Side-button medical tunic", href: "/product/side-button-medical-tunic" },
      { label: "Women's short lab coat", href: "/product/womens-short-lab-coat" },
      { label: "Maroon scrub set", href: "/product/maroon-scrub-set" },
      { label: "Premium cap", href: "/product/premium-cap" },
      { label: "Tote bag", href: "/product/tote-bag" },
      { label: "Sling / crossbody bag", href: "/product/crossbody-bag" },
      { label: "Crew socks", href: "/product/crew-socks" },
      { label: "All accessories", href: "/shop/accessories?gender=Women" },
      { label: "All medical uniforms", href: "/shop/doctor-aprons?gender=Women" },
    ] },
  ],
  Kids: [
    { heading: "T-shirts", links: [
    ...
    { heading: "Sports", links: [
      ...
      { label: "All sports", href: "/shop/sports?gender=Kids" },
    ] },
